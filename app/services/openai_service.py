    ...
    async def create_admin_assistant(self, admin_id: str) -> dict:
        ...
        try:
            tools = [ # list of dict
                ...
                },
                {
                    ...
                    "function": {
                        ...
                        "description": "Update an existing messaging draft with specific modifications. Return ONLY the core message content. NO greetings (Hello, Hi, Dear). NO sign-offs (Best, Regards, [Your Name]). DO NOT MAKE UP ANY INFORMATION -- DON'T ASSUME what is not provided please.",
                        "parameters": {
                            "type": "object",
                            "properties": {
            ...
            """ + """You currently specialize in student communications and campaign management. Your role is to assist school admins create and execute both MESSAGING(broadcast-type) and FEEDBACK(survey-type) communication campaigns.
                ...
                - As you write the revised message: PLEASE MAKE SURE: NO greetings(Hello, Hi, Dear) or sign-offs(Best, Regards, [Your Name]) even if provided by the admin. 
